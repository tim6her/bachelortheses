...
\begin{exlist}
\item Every field $F$ is especially a unital ring. Hen\-ce an $F$-vector space is an $F$-module. Therefore one can view modules as a generalization of vector spaces.
