...
%\endpgfgraphicnamed
%}
\caption{Upper bounds for the logarithmic growth of $\Gamma$ as in \cref{thm:Upper bound for the growth of Gamma}~(-\hspace{2pt}-), as stated by Bartholdi and \v{S}uni\'{c}~(\textbf{---}) as well as the recursion of \cref{thm:Upper bound for the growth of Gamma}~($\bullet $)}
...
\end{equation*}
and $(\id,b)=\psi_1(d)$. Thus, \cref{thm:psi k} implies $\psi_2(d)=(\id,\id,a,c)$. \cref{g:psi2(d)} illustrates the idea of the theorem. 
\begin{figure}
\begin{center}
